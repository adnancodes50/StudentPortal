...
public function attendances()
{
    ...
    {
        return strtolower((string) $this->session_type) . ' ( ' . $this->session_year . ' ) - ' . strtolower((string) $this->session_timing);
    }
...
{
    return $this->hasMany(CourseEvaluationReport::class, 'session_id', 'session_id');
}
